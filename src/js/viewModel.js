...
(function (ko) {
  ...
  function getSelectedItem(item) {
    return ko.utils.arrayFilter(ko.utils.unwrapObservable(item), function (
      item
    ) {
      return item.isSelected();
    });
  ...
  DragDropView.prototype.deleteItemFromToDo = function (data, model) {
    var items = getSelectedItems(this.todoCard);
  ...
  DragDropView.prototype.selectToDoSingleItem = function () {
    var items = getSelectedItem(this.todoCard);
    console.log(items);
    var item = {
        dragging: ko.observable(false),
        isSelected: ko.observable(false),
